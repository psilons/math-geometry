...
%----------------------------------------------------------------------------------------
    ...
    \begingroup
    \thispagestyle{empty}
	\AddToShipoutPicture*{\put(0,0){\includegraphics[scale=3]{cat1}}} % Image background
...
%----------------------------------------------------------------------------------------
    ...
    % https://bitbucket.org/amiede/classicthesis/issues/176/minitoc-package-does-not-work-with
    % try etoc, still not working
